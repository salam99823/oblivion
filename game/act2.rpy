...
label good_end:
    ...
    В очередной её визит, я решился расспросить о её опыте.
    ...
    спустя долгое время, ей это удалось.
    ...
    Сила воли и близкие люди помогли мне преодолеть разные невзгоды.

    Многие думают, что свои проблемы нужно обязательно решать самостоятельно.

    Но они ошибаются. Принятие помощи - это первый шаг к их решению. 
